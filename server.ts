...
if (drugCount.count === 0) {
  ...
  insertDrug.run('1', '激素药', '早饭后', '1粒', 1, '2026-03-05', 'bg-blue-500', 30, 1, 5, '2026-03-05');
  insertDrug.run('2', '羟氯喹', '晚饭后', '2粒', 1, '2026-03-05', 'bg-rose-500', 60, 2, 10, '2026-03-05');
  
  // Adding the one from their python script too as it seems important
